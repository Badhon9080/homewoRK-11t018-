                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <div class="header-top-link">
                            <ul class="quick-link">
                                <li><a href="index-1.html#">Help</a></li>@guest("customer")
                                <li><a href="{{ route("signup") }}">Join Us</a></li>
                                <li><a href="{{ route("signin") }}">Sign In</a></li>@endguest
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                let productsList = []
                    products.forEach(product =>
                       ...
                       `<div class="axil-product-list">
                        <div class="thumbnail">
                            <a href="${productUrl}">
                                      <img width="43px" src="{{ asset("storage/") }}/${product.featured_img}" alt="${product.title}">
                            </a>
                        </div>
                        <div class="product-content">
                            ...
                            <div class="product-price-variant">
                                <span class="price current-price">${product_selling_price}TK</span>
