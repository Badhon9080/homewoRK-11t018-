                                ...
                                <div class="col-lg-10 order-lg-2">
                                    <div class="single-product-thumbnail-wrap zoom-gallery">
                                        <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                            ...
                                            <div class="thumbnail">
                                                <a href="{{ asset("storage/") }}" class="popup-zoom">
                                                    <img src="{{ asset("storage/") }}" alt="Product Images">
                                                </a>
                                            </div>
                                ...
                                <div class="inner">
                                  ...
                                  <div class="position-relative">
                                    ...
                                    <ul class="product-meta">
                                        <li class="{{ $product->stock ? "text-primary" : "text-danger" }}"><i class="fal fa-check"></i>{{ $product->stock ? "in stock" : "out of stock" }}</li>
