                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                    <div class="axil-dashboard-overview">
                                        <div class="welcome-text">Hello  {{ auth("customer")->user()->name }}(not <span>?</span> <a href="{{ route("signout") }}">Log Out</a>)</div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @foreach ($order->orderItems as $item)
                                                                <div ><b>{{ $item->product->title }} <sub>({{ $item->amount / $item->qty }} * {{ $item->qty }})</sub></b><br>

                                                                </div>
                                                            @endforeach<p>{{ $order->created_at->format("d M,Y") }}</p>
                                                        </td>
                                                        <td>{{ $order->status }}</td>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="address-info mb--40">
                                                    ...
                                                    <ul class="address-details">
                                                        <li>Name: {{ auth("customer")->user()->name }} Mario</li>
                                                        <li>Email: {{ auth("customer")->user()->name }}@example.com</li>
